...
# 数据管理类
class EntryMaterialAdmin(PermissionView):
    # 列表视图可见列
    ...
    def __init__(self, session, name=None, category=None, endpoint=None, url=None):
        # 初始化
        super(EntryMaterialAdmin, self).__init__(EntryMaterial, session, name, category, endpoint, url)
